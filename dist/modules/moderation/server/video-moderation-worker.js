...
new bullmq_1.Worker("video-moderation", async (job) => {
    console.log("🔥 WORKER START", job.data);
    const { processVideoModeration } = await Promise.resolve().then(() => __importStar(require("../../../workflows/process-video-moderation")));
